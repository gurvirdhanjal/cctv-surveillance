...
**Phases 4N/4O/4P — Frontend Premium Polish & Data Completeness:** Spec approved `docs/superpowers/specs/2026-07-08-vms-frontend-premium-polish.md` (audit-backed; open questions resolved 2026-07-08). Three plans written, **NOT STARTED — awaiting user review**: `2026-07-08-vms-phase4n-design-language.md` (token/typography consolidation, hex+palette CI ban, minimal AppSidebar replacing shadcn, AlertCard/AlarmCard merge, CameraRow tree redesign, shell unification), `2026-07-08-vms-phase4o-ui-states-premium.md` (UI-state doctrine matrix, useNow/formatters, chart token ramp, command-palette actions, login brand moment), `2026-07-08-vms-phase4p-data-completeness.md` (7 new endpoint groups: persons detail, analytics KPI + head-count rollup, system metrics via scheduler→Redis, clip export 202-queued, users CRUD, bookmarks; **extended 2026-07-08** per the model-stack spec: Task 1b person timeline `GET /api/persons/{id}/timeline`, Tasks 8b/8c homography calibration API + `floor_plans` + heatmap/floor read APIs, Task 14b calibrator/heatmap/timeline frontend wiring; 5 migrations; orphan-endpoint wiring; dead-call removal). Execution order: 4N → 4O; 4P backend tasks parallelizable.
