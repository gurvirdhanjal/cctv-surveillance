...
async def test_orchestrator_feeds_person_id_from_identity_engine() -> None:
    ...
    with patch.object(orch, "_active_track_zones", return_value={gid1: 9, gid2: 9}):
        with patch.object(orch, "_zone_tracker", new=MagicMock()):
            with patch.object(orch, "_zone_lookup", return_value={}):
