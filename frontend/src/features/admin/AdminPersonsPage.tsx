...
const TIER_BADGE: Record<string, string> = {
  ...
  LOW: 'bg-surface-sunken text-text-tertiary',
}
    ...
    <>
      ...
      <div className="p-6">
        ...
        <input
          ...
          className="mb-4 w-full max-w-sm border border-border-subtle rounded px-3 py-2 text-[14px] bg-surface-base text-text-primary focus:outline-none focus:ring-2 focus:ring-brand-500"
        />
        ...
        {!isLoading && !isError && (
          <div className="rounded border border-border-subtle overflow-hidden">
                ...
                {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center px-4 py-3 border-b border-border-subtle hover:bg-surface-hover"
                    >
            ...
            {persons.length === 0 && (
              <p className="px-4 py-6 text-[14px] text-text-tertiary text-center">
                No persons found.
              </p>
            )}
          </div>
