...
export function ClipResultCard({ clip, onClick }: ClipResultCardProps) {
  return (
    <button
      onClick={onClick}
      className="w-full rounded-lg border border-border-DEFAULT bg-surface-base text-left shadow-1 transition-shadow hover:shadow-2 focus:outline-none focus:ring-2 focus:ring-brand-500"
